...
mavlink20.MAV_CMD_BATTERY_RESET = 42651 // Reset battery capacity for batteries that accumulate consumed battery
                        // via integration.
mavlink20.MAV_CMD_ENUM_END = 42652 // 
...
mavlink20.EKF_PRED_POS_HORIZ_ABS = 512 // Set if EKF's predicted horizontal position (absolute) estimate is
                        // good.
mavlink20.EKF_STATUS_FLAGS_ENUM_END = 513 // 
...
mavlink20.MAV_AUTOPILOT_ARDUPILOTMEGA = 3 // ArduPilot - Plane/Copter/Rover/Sub/Tracker, http://ardupilot.org
...
*/
mavlink20.messages.fence_status = function(breach_status, breach_count, breach_type, breach_time) {
...
mavlink20.messages.fence_status.prototype.pack = function(mav) {
    return mavlink20.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.breach_time, this.breach_count, this.breach_status, this.breach_type]));
}
...
*/
mavlink20.messages.statustext = function(severity, text) {
...
mavlink20.map = {
        ...
        162: { format: '<IHBB', type: mavlink20.messages.fence_status, order_map: [2, 1, 3, 0], crc_extra: 189 },
        ...
        253: { format: '<B50s', type: mavlink20.messages.statustext, order_map: [0, 1], crc_extra: 83 },
