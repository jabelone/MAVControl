...
*/
mavlink20.messages.event = function(destination_component, destination_system, id, time_boot_ms, sequence, log_levels, arguments) {
...
mavlink20.messages.event.prototype.pack = function(mav) {
    return mavlink20.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.id, this.time_boot_ms, this.sequence, this.destination_component, this.destination_system, this.log_levels, this.arguments]));
}
...
*/
mavlink20.messages.event_error = function(target_system, target_component, sequence, sequence_oldest_available, reason) {

    this.format = '<HHBBB';
    this.id = mavlink20.MAVLINK_MSG_ID_EVENT_ERROR;
    this.order_map = [2, 3, 0, 1, 4];
    this.crc_extra = 192;
    this.name = 'EVENT_ERROR';
